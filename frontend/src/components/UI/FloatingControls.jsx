...
import { Upload, Play, Navigation, Settings, X, FolderOpen } from 'lucide-react';
...
export default function FloatingControls({
    ...
    return (
        <div className="absolute bottom-20 right-4 flex flex-col gap-3 z-30 pointer-events-auto">
            ...
            {/* Load Demo (Dev/Prod conditional logic handled by parent) */}
            <button onClick={onLoadDemo} className={btnClass} title="Load Demo Data">
                <Play size={20} />
                <span className="absolute right-full mr-2 px-2 py-1 bg-zinc-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                    Load Demo
                </span>
            ...
            <button onClick={onOpenSettings} className={btnClass} title="Settings & Filters">
                <Settings size={20} />
                <span className="absolute right-full mr-2 px-2 py-1 bg-zinc-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                    Sidebar / Settings
                </span>
